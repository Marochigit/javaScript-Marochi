...
let matches = [];
if (window.location.href.includes('hamburguesas')) matches = ['hamburguesa'];
if (window.location.href.includes('lomitos')) matches = ['simple', 'completo', 'especial','veggie'];
if (window.location.href.includes('bebidas')) matches = ['bebidas'];
